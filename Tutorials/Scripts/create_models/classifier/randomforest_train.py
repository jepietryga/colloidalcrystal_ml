...
save_id = "NEW_MODEL"
model_directory = Path(__file__).parent.parent.parent.parent.parent /  "facet_ml" / "static" / "Models"

# Input Data
processed_data = Path(__file__).parent.parent.parent.parent.parent.parent / "CC_Manuscript_Data" 

csv_path = (
    processed_data / "Training_Data_20240216" / "2024_02_27_Processed.csv"
)
...
for trial_name, param_dict in model_trials.items():
    for key in key_list:
        ...
        df_run = replace_and_clean_labels_df(df_total, replace_dict)
